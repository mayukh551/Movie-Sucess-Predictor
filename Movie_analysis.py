...
while ws[movie_name].value is not None:
    ...
    # popular_actors += int(ws['D' + str(r)].value)
    # gd_actors += int(ws['F' + str(r)].value)
    # avg_actors += int(ws['E' + str(r)].value)
    # flop_actors += int(ws['F' + str(r)].value)
...
# print('Total Popular directors   :   ', popular_actors, f'  ->   {((popular_actors / count) * 100)}%')
# print('Total average directors   :   ', gd_actors, f' ->  {((gd_actors / count) * 100)}%')
# print('Total average directors   :   ', avg_actors, f' ->  {((avg_actors / count) * 100)}%')
# print('Total flop directors      :   ', flop_actors, f'   ->  {((flop_actors / count) * 100)}%')
